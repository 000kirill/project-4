...
так же для отправки файлов нужен токен для работы с телеграмм ботом, chat_id , время задержки отправления файлов, id от spacex, времнные рамки для скачивания фотографий NASA APOD .
